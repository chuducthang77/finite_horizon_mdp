...
from utils.calculate_v_dice_mdp import calculate_value_function
from utils.calculate_v_star_dice_mdp import calculate_optimal_value_function
...
def main(env, horizon, learning_rates, num_episodes, num_runs, is_show_plot=False, is_save_ind_file=True,
    ...
    # Initialization
    env = DiceStopEnv(horizon=horizon)
...
if __name__ == "__main__":
    ...
    main(env=config['env_name'], horizon=config['horizon'],
         ...
         is_save_ind_file=config['is_save_ind_file'], is_save_whole_file=config['is_save_whole_file'])
